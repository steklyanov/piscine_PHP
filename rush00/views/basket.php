        ...
        <div class="container flex-container">
            ...
            <?php if (isset($_SESSION["cart"])) {foreach($values as $num => $key){?>
                <div class="product-item">
                    <img src="<?php print $products[$num][3]?>" class="img">
                    <div class="product-list">
                        <form method="POST" action="remove_from_basket.php">
                            <p style="price">
                            <p style="text-align:center;"><?php print $products[$num][1];?></p>
                            <p style="text-align:center;color:#04B745;"><b><?php print $products[$num][4];?></b></p>
                            <p style="text-align:center;color:#04B745;"><b><?php print $key;?></b></p>
                            <input type="hidden" name="sku" value="<?php print $products[$num - 1][0]?>">
                            <button class="button" type="submit" name="delete" value="<?php print $products[$num][0]?>">Delete</button>
                            </p>
                        </form>
                    </div>
                </div>
